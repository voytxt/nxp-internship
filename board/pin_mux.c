...
- {pin_num: '79', pin_signal: CMP0_IN1/PTC7/SPI0_SIN/USB_SOF_OUT/I2S0_RX_FS/FB_AD8, label: 'J1[13]', identifier: BT_N}
- {pin_num: '70', pin_signal: ADC0_SE14/PTC0/SPI0_PCS4/PDB0_EXTRG/USB_SOF_OUT/FB_AD14/I2S0_TXD1, label: 'J1[11]', identifier: ENC_b;ENC_B}
- {pin_num: '84', pin_signal: PTC12/UART4_RTS_b/FB_AD27/FTM3_FLT0, label: 'J2[2]'}
- {pin_num: '76', pin_signal: PTC4/LLWU_P8/SPI0_PCS0/UART1_TX/FTM0_CH3/FB_AD11/CMP1_OUT, label: 'J2[4]', identifier: MFP}
- {pin_num: '93', pin_signal: PTD0/LLWU_P12/SPI0_PCS0/UART2_RTS_b/FTM3_CH0/FB_ALE/FB_CS1_b/FB_TS_b, label: 'J2[6]', identifier: SW1;SW1_EXT}
- {pin_num: '95', pin_signal: PTD2/LLWU_P13/SPI0_SOUT/UART2_RX/FTM3_CH2/FB_AD4/I2C0_SCL, label: SW2_EXT, identifier: SW2_EXT}
- {pin_num: '96', pin_signal: PTD3/SPI0_SIN/UART2_TX/FTM3_CH3/FB_AD3/I2C0_SDA, label: 'J2[10]', identifier: SW3;SW3_EXT}
- {pin_num: '94', pin_signal: ADC0_SE5b/PTD1/SPI0_SCK/UART2_CTS_b/FTM3_CH1/FB_CS0_b, label: 'J2[12]', identifier: SW4_EXT}
...
- {pin_num: '66', pin_signal: PTB20/SPI2_PCS0/FB_AD31/CMP0_OUT, label: 'J6[3]/J4[9]/RF_WIFI_CE', identifier: BUZZER}
- {pin_num: '17', pin_signal: ADC1_DM1, label: 'J4[7]'}
- {pin_num: '16', pin_signal: ADC1_DP1, label: 'J4[5]'}
- {pin_num: '15', pin_signal: ADC0_DM1, label: 'J4[3]', identifier: TEMP_OUT}
- {pin_num: '14', pin_signal: ADC0_DP1, label: 'J4[1]', identifier: TEMP_IN}
...
- {pin_num: '82', pin_signal: ADC1_SE6b/PTC10/I2C1_SCL/FTM3_CH6/I2S0_RX_FS/FB_AD5, label: 'J4[12]', identifier: D_RS}
...
- {pin_num: '34', pin_signal: PTA0/UART0_CTS_b/UART0_COL_b/FTM0_CH5/JTAG_TCLK/SWD_CLK/EZP_CLK, label: 'J9[4]/SWD_CLK', identifier: MFP}
...
- pin_list:
  ...
  - {pin_num: '81', peripheral: GPIOC, signal: 'GPIO, 9', pin_signal: ADC1_SE5b/CMP0_IN3/PTC9/FTM3_CH5/I2S0_RX_BCLK/FB_AD6/FTM2_FLT0, direction: INPUT, pull_select: up,
    pull_enable: enable}
  - {pin_num: '70', peripheral: GPIOC, signal: 'GPIO, 0', pin_signal: ADC0_SE14/PTC0/SPI0_PCS4/PDB0_EXTRG/USB_SOF_OUT/FB_AD14/I2S0_TXD1, identifier: ENC_B, direction: INPUT,
  ...
  - {pin_num: '93', peripheral: GPIOD, signal: 'GPIO, 0', pin_signal: PTD0/LLWU_P12/SPI0_PCS0/UART2_RTS_b/FTM3_CH0/FB_ALE/FB_CS1_b/FB_TS_b, identifier: SW1_EXT, direction: INPUT,
    pull_select: up, pull_enable: enable}
  - {pin_num: '95', peripheral: GPIOD, signal: 'GPIO, 2', pin_signal: PTD2/LLWU_P13/SPI0_SOUT/UART2_RX/FTM3_CH2/FB_AD4/I2C0_SCL, direction: INPUT, pull_select: up,
    pull_enable: enable}
  - {pin_num: '96', peripheral: GPIOD, signal: 'GPIO, 3', pin_signal: PTD3/SPI0_SIN/UART2_TX/FTM3_CH3/FB_AD3/I2C0_SDA, identifier: SW3_EXT, direction: INPUT, pull_select: up,
    pull_enable: enable}
...
void BOARD_InitPins(void)
{
    ...
    GPIO_PinInit(BOARD_LED_R_GPIO, BOARD_LED_R_PIN, &LED_R_config);

    gpio_pin_config_t MFP_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTC4 (pin 76)  */
    GPIO_PinInit(BOARD_MFP_GPIO, BOARD_MFP_PIN, &MFP_config);
    ...
    gpio_pin_config_t SW1_EXT_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTD0 (pin 93)  */
    GPIO_PinInit(BOARD_SW1_EXT_GPIO, BOARD_SW1_EXT_PIN, &SW1_EXT_config);

    gpio_pin_config_t SW4_EXT_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTD1 (pin 94)  */
    GPIO_PinInit(BOARD_SW4_EXT_GPIO, BOARD_SW4_EXT_PIN, &SW4_EXT_config);

    gpio_pin_config_t SW2_EXT_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTD2 (pin 95)  */
    GPIO_PinInit(BOARD_SW2_EXT_GPIO, BOARD_SW2_EXT_PIN, &SW2_EXT_config);

    gpio_pin_config_t SW3_EXT_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTD3 (pin 96)  */
    GPIO_PinInit(BOARD_SW3_EXT_GPIO, BOARD_SW3_EXT_PIN, &SW3_EXT_config);
    ...
    PORT_SetPinMux(BOARD_MFP_PORT, BOARD_MFP_PIN, kPORT_MuxAsGpio);
    ...
    PORT_SetPinMux(BOARD_SW1_EXT_PORT, BOARD_SW1_EXT_PIN, kPORT_MuxAsGpio);
    ...
    PORT_SetPinMux(BOARD_SW4_EXT_PORT, BOARD_SW4_EXT_PIN, kPORT_MuxAsGpio);
    ...
    PORT_SetPinMux(BOARD_SW2_EXT_PORT, BOARD_SW2_EXT_PIN, kPORT_MuxAsGpio);
    ...
    PORT_SetPinMux(BOARD_SW3_EXT_PORT, BOARD_SW3_EXT_PIN, kPORT_MuxAsGpio);
...
- options: {callFromInitBoot: 'false', prefix: BOARD_, coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: '50', peripheral: OSC, signal: EXTAL0, pin_signal: EXTAL0/PTA18/FTM0_FLT2/FTM_CLKIN0, identifier: EXTAL0}
...
void BOARD_InitENETPins(void)
{
    ...
    PORT_SetPinConfig(BOARD_INITENETPINS_RMII0_RXD1_PORT, BOARD_INITENETPINS_RMII0_RXD1_PIN, &RMII0_RXD1);
    ...
    PORT_SetPinConfig(BOARD_INITENETPINS_RMII0_RXD0_PORT, BOARD_INITENETPINS_RMII0_RXD0_PIN, &RMII0_RXD0);
    ...
    PORT_SetPinConfig(BOARD_INITENETPINS_RMII0_CRS_DV_PORT, BOARD_INITENETPINS_RMII0_CRS_DV_PIN, &RMII0_CRS_DV);
    ...
    PORT_SetPinConfig(BOARD_INITENETPINS_RMII0_TXEN_PORT, BOARD_INITENETPINS_RMII0_TXEN_PIN, &RMII0_TXEN);
    ...
    PORT_SetPinConfig(BOARD_INITENETPINS_RMII0_TXD0_PORT, BOARD_INITENETPINS_RMII0_TXD0_PIN, &RMII0_TXD0);
    ...
    PORT_SetPinConfig(BOARD_INITENETPINS_RMII0_TXD1_PORT, BOARD_INITENETPINS_RMII0_TXD1_PIN, &RMII0_TXD1);
    ...
    const port_pin_config_t RMII_RXCLK = {/* Internal pull-up/down resistor is disabled */
                                          ...
                                          kPORT_UnlockRegister};
    /* PORTA18 (pin 50) is configured as EXTAL0 */
    PORT_SetPinConfig(BOARD_INITENETPINS_RMII_RXCLK_PORT, BOARD_INITENETPINS_RMII_RXCLK_PIN, &RMII_RXCLK);
    ...
    PORT_SetPinConfig(BOARD_INITENETPINS_RMII0_RXER_PORT, BOARD_INITENETPINS_RMII0_RXER_PIN, &RMII0_RXER);
    ...
    PORT_SetPinConfig(BOARD_INITENETPINS_RMII0_MDIO_PORT, BOARD_INITENETPINS_RMII0_MDIO_PIN, &RMII0_MDIO);
    ...
    PORT_SetPinConfig(BOARD_INITENETPINS_RMII0_MDC_PORT, BOARD_INITENETPINS_RMII0_MDC_PIN, &RMII0_MDC);
...
void BOARD_InitSDHCPins(void)
{
    ...
    GPIO_PinInit(BOARD_INITSDHCPINS_SDHC_CD_GPIO, BOARD_INITSDHCPINS_SDHC_CD_PIN, &SDHC_CD_config);
    ...
    PORT_SetPinConfig(BOARD_INITSDHCPINS_SDHC0_DCLK_PORT, BOARD_INITSDHCPINS_SDHC0_DCLK_PIN, &SDHC0_DCLK);
    ...
    PORT_SetPinConfig(BOARD_INITSDHCPINS_SDHC0_CMD_PORT, BOARD_INITSDHCPINS_SDHC0_CMD_PIN, &SDHC0_CMD);
    ...
    PORT_SetPinConfig(BOARD_INITSDHCPINS_SDHC0_D3_PORT, BOARD_INITSDHCPINS_SDHC0_D3_PIN, &SDHC0_D3);
    ...
    PORT_SetPinConfig(BOARD_INITSDHCPINS_SDHC0_D2_PORT, BOARD_INITSDHCPINS_SDHC0_D2_PIN, &SDHC0_D2);
    ...
    PORT_SetPinConfig(BOARD_INITSDHCPINS_SDHC_CD_PORT, BOARD_INITSDHCPINS_SDHC_CD_PIN, &SDHC_CD);
}
